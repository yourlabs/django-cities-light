    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_ascii",
                    models.CharField(db_index=True, max_length=200, blank=True),
                ),
                ...
                (
                    "code2",
                    models.CharField(max_length=2, unique=True, null=True, blank=True),
                ),
                (
                    "code3",
                    models.CharField(max_length=3, unique=True, null=True, blank=True),
                ),
                (
                    "continent",
                    models.CharField(
