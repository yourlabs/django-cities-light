...
class TestUpdate(TestImportBase):
    ...
    def test_update_fields(self):
        ...
        Fixture(
            fixture_dir.get_file_path("update_fields.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_update_fields_wrong_timezone(self):
        ...
        Fixture(
            fixture_dir.get_file_path("update_fields_wtz.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_change_country(self):
        ...
        Fixture(
            fixture_dir.get_file_path("change_country.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_change_region_and_country(self):
        ...
        Fixture(
            fixture_dir.get_file_path("change_region_and_country.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_keep_slugs(self):
        ...
        Fixture(
            fixture_dir.get_file_path("keep_slugs.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_add_records(self):
        ...
        Fixture(
            fixture_dir.get_file_path("add_records.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_noinsert(self):
        ...
        Fixture(
            fixture_dir.get_file_path("noinsert.json"), ignore_pk=True
        ).assertNoDiff()
    ...
    def test_remove_records(self):
        ...
        Fixture(
            fixture_dir.get_file_path("remove_records.json"), ignore_pk=True
        ).assertNoDiff()
