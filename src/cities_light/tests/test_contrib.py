...
from ..contrib.ajax_selects_lookups import CountryLookup, RegionLookup, CityLookup
...
class TestAjaxSelectsLookups(TestImportBase):
    ...
    def test_country_lookup(self):
        ...
        self.assertEqual(len(lookup_query), 2, msg="2 countries should be found")
        self.assertEqual(lookup_query[0].name, "Russia")
    ...
    def test_region_lookup(self):
        ...
        self.assertEqual(len(lookup_query), 2, msg="2 regions should be found")
        self.assertEqual(lookup_query[0].name, "Kemerovo")
